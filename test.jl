...
aMatrix = [
    @interval(1, 1) @interval(0, 0) @interval(1, 2);
    @interval(0, 0) @interval(1, 1) @interval(0, 0);
    @interval(0, 0) @interval(0, 0) @interval(1, 1);
];
m = [
    1 0 1;
    -0 -5.1 1;
...
print(ILESolver.solve(aMatrix, bVector), "\n")
